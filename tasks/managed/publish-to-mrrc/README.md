...
| IMAGE                   | Reference to the OCI-Artifact that merge step will generate from multiple snapshots, serving as an intermediate artifact for RADAS signing | Yes      | quay.io/konflux-mrrc/mrrc-merge |
